        ...
        <div class="contact-area__header">
          ...
          <div class="contact-area__access">
            <address class="contact-area__info">
              <?php
              $company_info = get_field('company_info', 28);
              ?>
              <span><?php echo esc_html($company_info["address"]); ?></span>
              <span><a href="tel:01200000000">TEL:<?php echo esc_html($company_info["phone_numbers"]); ?></a></span>
              <span>営業時間:<?php echo esc_html($company_info["open_time"]); ?>-<?php echo esc_html($company_info["close_time"]); ?></span>
              <span>定休日:<?php echo esc_html($company_info["close_day"]); ?></span>
            </address>
